public class Mover implements Runnable {
	...
	public Mover(MainFrame frame, String name, Semaphore mutex1,
			Semaphore mutex2, Semaphore full1, Semaphore full2,
	...
	public void run() {
		while (true) {
			...
			mutex1.p();
			mutex2.p();
			frame.jta.append("Mover " + name + " move a product from Buffer "
					+ buf1.number + " to Buffer " + buf2.number + "\n");
			moveTimes++;
			buf1.value--;
			buf2.value++;
			if (buf1.number == 1) {
