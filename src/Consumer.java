public class Consumer implements Runnable{
	...
	public Consumer(MainFrame frame,String name,Semaphore mutex,Semaphore full,Semaphore empty,Buffer buf){
		this.mutex=mutex;
		this.full=full;
		this.empty=empty;
		this.buf=buf;
	...
	public void run(){
		while(true){
			full.p();
			mutex.p();
			frame.jta.append("Consumer "+name+" get a product from "+buf.number+"\n");
			timesOfConsumer++;
			buf.value--;
